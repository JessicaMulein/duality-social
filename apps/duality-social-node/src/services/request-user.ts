import { IRequestUser, IRoleDocument,  IUserDocument } from "@duality-social/duality-social-lib";
...
export class RequestUserService {
   ...
   * @returns 
   */
  public static makeRequestUser(userDoc: IUserDocument, roles: IRoleDocument[]): IRequestUser {
    if (!userDoc._id) {
