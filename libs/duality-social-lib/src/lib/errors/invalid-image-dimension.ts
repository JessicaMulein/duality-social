...
export class InvalidImageDimensionError extends Error {
    constructor(width: number, height: number) {
        super(`Invalid image dimensions: width=${width}, height=${height} exceeds maximum allowed dimensions of ${AppConstants.MaxImageDimensions.width}x${AppConstants.MaxImageDimensions.height}px.`);
